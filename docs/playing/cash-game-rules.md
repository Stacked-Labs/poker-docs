...
1. **Pre-flop.** Small blind and big blind post. Each player gets two hole cards. Action starts to the left of the big blind.
2. **Flop.** Three community cards. Action starts to the left of the button.
3. **Turn.** A fourth community card. Same action order.
4. **River.** A fifth community card. Same action order.
5. **Showdown.** Remaining players reveal. Best five-card hand wins the pot.

If you're new to Hold'em, the [Wikipedia article on Texas Hold'em](https://en.wikipedia.org/wiki/Texas_hold_%27em) is a clean reference for hand rankings and betting structure.
...
This page covers cash games, where blinds don't increase over time and you can join or leave between hands without losing your stack — your stack is your stack until you withdraw it. Stacked also runs tournaments, where the blinds climb and you play down to a prize pool; see [Tournaments](/docs/playing/tournaments) for how those work.

## What's next

- [At the table →](/docs/playing/at-the-table) — controls and UX during a hand.
- [Free Play vs real-money →](/docs/playing/free-play-vs-real-money) — same rules, different chips.
